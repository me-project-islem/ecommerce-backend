...
async function createAdmin() {
    ...
    try {
        const existing = await queryRunner.query(`SELECT * FROM "user" WHERE email = $1`, ['admin@ecommerce.com']);
        ...
        await queryRunner.query(`INSERT INTO "user" (email, name, password, role) VALUES ($1, $2, $3, $4)`, ['admin@ecommerce.com', 'Administrator', hashedPassword, 'admin']);
        console.log('');
